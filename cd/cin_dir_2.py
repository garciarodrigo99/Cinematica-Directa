...
a  = [   0,p[1],   2]
al = [   0,  90,   0]
#al2 es 90 porque es perpendicular
...
#Distancia (d): La distancia desde el eje Z anterior al punto de intersección del eje Z actual con la línea normal común. Representa la distancia entre dos articulaciones a lo largo del eje Z.
#Ángulo (θ): El ángulo entre el eje Z anterior y el eje Z actual alrededor del eje X común, medida en sentido antihorario. Representa la rotación entre dos articulaciones alrededor del eje Z común.
#Longitud (a): La longitud del eslabón a lo largo del eje X común. Representa la distancia entre dos articulaciones a lo largo del eje X.
#Ángulo de inclinación (α): El ángulo entre el eje X anterior y el eje X actual alrededor del eje Z común, medida en sentido antihorario. Representa la inclinación del eslabón entre dos articulaciones.